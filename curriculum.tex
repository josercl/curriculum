...
\item \textbf{Software de desarrollo de SCADAs:} Ignition by Inductive Automation
\end{itemize}
...
\begin{itemize}
    \item Ignition Gold Certified Developer. Inductive Automation. 2013
    \item Ignition Core Certified Developer. Inductive Automation. 2013
\end{itemize}
...
\subsection*{Desarrollador - ESEPRIN C.A.}
  \begin{itemize}
    \item Desarrollo de Plantillas y Scripts para Ignition
